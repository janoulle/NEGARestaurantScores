...
public class RestaurantController {
    ...
    public List<Restaurant> getRestaurantByNameAndCounty(@RequestHeader("name") String name, @RequestHeader("county") String county){
        logger.info(String.format("finding restaurant by name %s and county %s" ,name,county));
    ...
    @RequestMapping(value = "/score/greaterorequal/{score}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    public List<Restaurant> getRestaurantsWithScoresGreaterThanOrEqual(@PathVariable("score") int score) {
        return restaurantRepository.findRestaurantsWithScoresGreaterThanOrEqual(score);
    }

    @Cacheable("scoresLesserThan")
    @RequestMapping(value = "/score/lesserorequal/{score}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    public List<Restaurant> getRestaurantsWithScoresLessThanOrEqual(@PathVariable("score") int score) {
    ...
    @RequestMapping(value = "/violations/critical", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
